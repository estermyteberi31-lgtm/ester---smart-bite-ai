    ...
    icon: (active) => (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6">
        <path
          ...
          stroke={active ? "#a855f7" : "currentColor"}
          strokeWidth="1.8"
          strokeLinejoin="round"
        />
        <circle cx="16.5" cy="7.5" r="3.4" fill={active ? "#a855f7" : "#4c1d95"} stroke="#0f0b1a" strokeWidth="1" />
        <path
    ...
    icon: (active) => (
      <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6">
        <path
          ...
          strokeLinecap="round"
        />
        <rect x="5" y="8" width="2.5" height="8" rx="0.8" fill={active ? "#a855f7" : "currentColor"} />
        <rect x="16.5" y="8" width="2.5" height="8" rx="0.8" fill={active ? "#a855f7" : "currentColor"} />
      </svg>
    ),
  },
  {
